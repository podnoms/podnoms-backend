...
public class UserController : BaseAuthController {
  ...
  [HttpGet("activity")]
  public async Task<ActionResult<Common.Data.Paging.PagedResult<UserActivityViewModel>>> GetUsers(
    [FromQuery] int currentPage, [FromQuery] int pageSize, [FromQuery] string sortBy,

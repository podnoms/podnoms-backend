    ...
    Options = new Dictionary<string, NotificationOption> {
      {
        ...
        "Device",
        new NotificationOption("Device", "Device",
          "Blank for all or a device iden which can be found by sending an authenticated get to https://api.pushbullet.com/v2/devices",
          false)
      },

...
public class ApplicationUser : IdentityUser, ISluggedEntity {
  ...
  public virtual List<AccountSubscription> AccountSubscriptions { get; set; } = new();
  ...
  public virtual List<IssuedApiKey> IssuedApiKeys { get; set; } = new();

  public int? PlaylistAllowedEntryCount { get; set; }

  [SlugField("FullName")] public string Slug { get; set; }
  ...
  public string GetImageUrl(string cdnUrl, string containerName) {
    return GetImageUrl(cdnUrl, containerName, "jpg");
  }

  public string GetImageUrl(string cdnUrl, string containerName, string extension) {
    return PictureUrl.StartsWith("http") && !PictureUrl.Contains("cdn.podnoms.com")
  ...
  public string GetThumbnailUrl(string cdnUrl, string containerName) {
    return GetThumbnailUrl(cdnUrl, containerName, "jpg");
  }

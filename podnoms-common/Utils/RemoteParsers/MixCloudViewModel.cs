...
namespace PodNoms.Common.Utils.RemoteParsers {
    public class MixcloudApiResult {
        [JsonProperty("paging")] public Paging Paging { get; set; }

        [JsonProperty("data")] public MixcloudShowItem[] Shows { get; set; }

        [JsonProperty("name")] public string Name { get; set; }
    }

    public class MixcloudShowItem {
        ...
        [JsonProperty("audio_length")] public long AudioLength { get; set; }

        [JsonProperty("slug")] public string Slug { get; set; }

        [JsonProperty("favorite_count")] public long FavoriteCount { get; set; }

        [JsonProperty("listener_count")] public long ListenerCount { get; set; }
    ...
    public class Pictures {
        ...
        [JsonProperty("320wx320h")] public string The320Wx320H { get; set; }

        [JsonProperty("extra_large")] public string ExtraLarge { get; set; }

        [JsonProperty("large")] public string Large { get; set; }

        [JsonProperty("640wx640h")] public string The640Wx640H { get; set; }

        [JsonProperty("medium_mobile")] public string MediumMobile { get; set; }

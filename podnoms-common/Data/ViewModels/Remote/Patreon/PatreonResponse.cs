...
public class CurrentlyEntitledTiers {
  [JsonPropertyName("data")] public List<Datum> Tiers { get; set; }
}
...
public class PatreonResponse {
  [JsonPropertyName("data")] public SubscriberData SubscriberData { get; set; }

  [JsonPropertyName("included")] public List<SubscriberSubscriptionData> Subscriptions { get; set; }

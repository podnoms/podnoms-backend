...
namespace PodNoms.Api.Utils {
    public class ImageUtils {
        ...
        internal static string GetTemporaryImage(string type, int upperBound, string extension = "png") {
            return $"{type}/image-{Randomisers.RandomInteger(1, upperBound)}.{extension}";
        }
        internal static (string, string) ConvertFile(string file, string prefix, string outputType="png") {
        ...
        internal static string CreateThumbnail(string cacheFile, string prefix, int width, int height, string extension = "png") {
